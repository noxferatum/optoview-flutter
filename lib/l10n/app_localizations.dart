...
abstract class AppLocalizations {
  ...
  /// No description provided for @selectSpeed.
  ///
  /// In en, this message translates to:
  /// **'Stimulus speed'**
  ...
  /// No description provided for @symbolCircle.
  ///
  /// In en, this message translates to:
  /// **'Circle'**
  String get symbolCircle;

  /// No description provided for @symbolLetter.
  ///
  /// In en, this message translates to:
  /// **'Letter'**
  String get symbolLetter;

  /// No description provided for @symbolFace.
  ///
  /// In en, this message translates to:
  /// **'Face'**
  String get symbolFace;
  ...
  /// No description provided for @correctTaps.
  ///
  /// In en, this message translates to:
  /// **'Correct taps'**
  String get correctTaps;
}
